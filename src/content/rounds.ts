...
/**
 * Elite and Boss are the same kind of word, since both name an encounter, which is
 ...
 *
 * Known debt: the elite is elite only in its target and its payout, and the rule
